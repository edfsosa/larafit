<x-layouts.app :title="__('Create Routine')">
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">{{ __('Create New Routine') }}</h1>
        ...
        <!-- Formulario -->
        <form action="{{ route('routines.store') }}" method="POST" class="space-y-4">
            @csrf
